                ...
                <div class="card">
                    <div class="card-body" style="overflow-x:auto">
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <nav class="nav nav-pills">
                                    ...
                                    <a class="nav-item nav-link" id="nav-profile-tab" href="<?= site_url() ?>/guest/view_history_drp">DRP & SPPBJ</a>
                        ...
                        <div class="table-responsive">
                            <table id="table1" class="table table-sm table-striped table-bordered table-hover" role="grid" style="width: 100%" width="100%" cellspacing="0">
                                <thead>
