                ...
                <div class="card">
                    ...
                    <div class="card-body" style="overflow-x:auto">
                        ...
                        <nav class="nav nav-pills">
                            ...
                            <a class="nav-link" href="#" id="navSPPBJ">DRP & SPPBJ</a>
                        ...
                        <!-- Tabel DRP & SAPPBJ -->
                        <div class="table-responsive">
                            <table id="tableSPPBJ" class="table table-sm table-striped table-bordered table-hover" role="grid" style="width: 100%" width="100%" cellspacing="0">
                                <thead>
                                    <tr role="row" style="white-space: nowrap">
                                        <th>No.</th>
                                        <th>No. DRP</th>
