                        ...
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <nav class="nav nav-pills">
                                    ...
                                    <a class="nav-item nav-link" id="nav-profile-tab" href="<?= site_url() ?>/tabel/tabel_drp">DRP & SPPBJ</a>
                                    <a class="nav-link active" id="nav-contact-tab" data-toggle="tab" href="#nav-contact">Kontrak</a>
                                </nav>
                            </div>
                        </div>
                        <!-- Tabel Kontrak -->
                        <div class="table-responsive tab-pane" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
